...
function Reclamations({ api, notify, data, submit, user, searchQuery = '' }) {
  ...
  const [editing, setEditing] = useState(null);
  const canProcessComplaint = ['manager', 'vendeur'].includes(user?.role);
